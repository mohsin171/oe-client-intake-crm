...
export const CONFIG = {
  firm: {
    ...
    availability: {
      ...
      days: {
        1: [9.5, 11, 12.5, 15, 16.5],   // Mon
        2: [9.5, 11, 12.5, 15, 16.5],   // Tue
        3: [9.5, 11, 12.5, 15, 16.5],   // Wed
        4: [9.5, 11, 12.5, 15, 16.5],   // Thu
        5: [9.5, 11, 12.5, 15],         // Fri (wind down earlier)
        6: [9.5, 11, 12],               // Sat morning only
      },
      ...
      perDay: 3,              // up to 3 times per day (morning / midday / afternoon)
