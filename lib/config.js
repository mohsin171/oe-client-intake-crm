...
export const CONFIG = {
  firm: {
    ...
    offices: [
      { city: "Reading", address: "14 Kings Walk, Reading RG1 2HG", note: "Head office; appointments by phone call or in person." },
    ],
    ...
    nextSteps: "The best next step is a free, no-obligation fact-find call: about 20 minutes by phone (or pop into our office if you would rather meet in person), to understand your situation and outline the options.",

    bookingType: "fact-find call",
    bookingHours: "Monday to Friday 9am to 5pm, and Saturday 9am to 1pm",

    // Real booking availability the slot engine uses, so offered times reflect
    // when this firm actually takes appointments (not arbitrary slots).
    availability: {
      // 0=Sun ... 6=Sat. Each open day lists its appointment start hours (24h).
      days: {
        1: [9, 9.5, 10.5, 11.5, 13, 14, 15, 16],   // Mon
        2: [9, 9.5, 10.5, 11.5, 13, 14, 15, 16],   // Tue
        3: [9, 9.5, 10.5, 11.5, 13, 14, 15, 16],   // Wed
        4: [9, 9.5, 10.5, 11.5, 13, 14, 15, 16],   // Thu
        5: [9, 9.5, 10.5, 11.5, 13, 14],           // Fri (wind down earlier)
        6: [9, 9.5, 10, 10.5, 11, 11.5],           // Sat morning only
      },
      slotMinutes: 30,        // appointment length
      minNoticeHours: 3,      // earliest bookable time from now
      workingDays: 5,         // spread across the next 5 open days
      perDay: 10,             // show every open time for the day (at least 6)
      timezone: "Europe/London", // display slots in the firm's timezone
    },
    ...
    captureFields: [
      ...
      { key: "preferred_time", label: "Preferred appointment day/time (their own words)" },
    ],
  },
