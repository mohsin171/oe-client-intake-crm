...
export const CONFIG = {
  ...
  widget: {
    ...
    greeting: "Hi, thanks for visiting Rivergate Mortgages. I can answer questions about mortgages, remortgaging, and buy-to-let, and arrange a free fact-find call with an adviser. How can I help today?",
  },

  ai: {
    // Haiku 4.5: fast and cheap for a public demo. Swap to a larger model per client.
